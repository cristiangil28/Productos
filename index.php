...
<main id="app" class="container  center">
    ...
    <section class="row valign-wrapper">
      <div class="col s10">
        <h3 class="left">Lista de Productos</h3>
      </div>
      <div class="col s2">
    ...
    <transition name="fade">
      <table class="responsive-table  striped">
        ...
        <tr v-for="producto in productos" :key="producto.id_productos">
          <td>{{producto.id_productos}}</td>
          <td>{{producto.nombre_producto}}</td>
          <td>{{producto.imagen}}</td>
          <td>{{producto.descripcion}}</td>
          <td>
            <button class="btn btn-floating" @click="getProducto('edit', producto)">
              <i class="material-icons">edit</i>
              </span>
            </button>
          </td>
          <td>
            <button class="btn btn-floating" @click="getProducto('delete', producto)">
        ...
        <div class="ModalWindow-container">
          <header class="ModalWindow-heading">
            <div class="row valign-wrapper">
              <div class="col s10">
                <h4 class="left">Agregar Producto</h4>
              </div>
              <div class="col s2">
          ...
          <form class="ModalWindow-content row" @submit.prevent="createProducto">
            <div class="input-field col s12">
              <i class="material-icons prefix">account_circle</i>
              <input name="name" type="text" placeholder="Nombre" required>
            </div>
            <div class="input-field col s12">
              <i class="material-icons prefix">imagen</i>
              <input name="image" type="text" placeholder="imagen" required>
            </div>
            <div class="input-field col s12">
              <i class="material-icons prefix">web</i>
              <input name="description" type="text" placeholder="descripcioón" required>
            </div>
            <div class="input-field col s12">
      ...
      <section :class="['ModalWindow', displayEditModal]" v-if="showEditModal">
        <div class="ModalWindow-container">
          <header class="ModalWindow-heading">
            <div class="row valign-wrapper">
              <div class="col s10">
                <h4 class="left">Editar Producto</h4>
              </div>
              <div class="col s2">
          ...
          <form class="ModalWindow-content row" @submit.prevent="updateProducto">
            <div class="input-field col s12">
              <i class="material-icons prefix">account_circle</i>
              <input v-model="activeProducto.name" name="name" type="text" placeholder="Nombre" required>
            </div>
            <div class="input-field col s12">
              <i class="material-icons prefix">email</i>
              <input v-model="activeProducto.imagen" name="imagen" type="text" placeholder="imagen" required>
            </div>
            <div class="input-field col s12">
              <i class="material-icons prefix">web</i>
              <input v-model="activeProducto.descripcion" name="descripcion" type="text" placeholder="descripcion" required>
            </div>
            <div class="input-field col s12">
              <button class="btn-large btn-floating right" type="submit">
                <i class="material-icons">save</i>
              </button>
              <input v-model="activeProducto.id_productos" name="id" type="hidden" required>
            </div>
          </form>
        </div>
      </section>
      ...
      <section :class="['ModalWindow', displayDeleteModal]" v-if="showDeleteModal">
        <div class="ModalWindow-container">
          <header class="ModalWindow-heading">
            <div class="row valign-wrapper">
              <div class="col s10">
                <h4 class="left">Eliminar Producto</h4>
              </div>
              <div class="col s2">
          ...
          <form class="ModalWindow-content row" @submit.prevent="deleteProducto">
            <div class="input-field col s12">
              <p class="flow-text center">¿Estás seguro de eliminar al producto: <b>{{activeProducto.name}}</b>.</p>
              <input v-model="activeProducto.id" name="id" type="hidden" required>
            </div>
